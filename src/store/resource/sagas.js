...
export function* readResourceList(api, { params }, { resource, thunk }) {
  try {
    const list = yield call([api, api.post], `/${params.apiRequestParams.endpoint}`, { ...params.apiRequestParams })
    yield put(actions.resourceListReadSuccess(resource, list.d, { params }, thunk))
  } catch (e) {
...
export function* readResourceDetail(api, { params }, { resource, thunk }) {
  try {
    const detail = yield call([api, api.post], `/${params.apiRequestParams.endpoint}`, { ...params.apiRequestParams })
    yield put(actions.resourceDetailReadSuccess(resource, detail.d, { params }, thunk))
  } catch (e) {
