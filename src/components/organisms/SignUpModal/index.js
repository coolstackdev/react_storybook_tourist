...
const SignUpTypeSwitch = styled(Paragraph)`
...
const SignUpModal = ({
  ...
  return (
    <Modal title={signInType === 'login' ? "Login" : "Register"} name="register" closeable {...props}>
      <Wrapper>
        ...
        <HorizontalRule />
          ...
          <Form onSubmit={handleSubmit} emailHidden={emailHidden} method="post">
            ...
            <ButtonWrapper>
              <SignUpButton type="submit" disabled={isWaiting("SignIn")} icon="shield">
          ...
          <SignUpTypeSwitch onClick={changeSigninType}>
